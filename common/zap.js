...
function edit() {
	...
	if (!ans) {
		...
		$("#combo").css("background-image", `url(resources/old/${ans[0]}.png)`)
		$("#zap1").attr("src", `resources/old/${ans[1]}.png`)
		$("#zap2").attr("src", `resources/old/${ans[2]}.png`)
		$("#squirt1").attr("src", `resources/old/${ans[3] || ans[4]}.png`)
		$("#squirt2").attr("src", `resources/old/${ans[5] || ans[6]}.png`)
